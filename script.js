...
function lastmessage() {
    ...
    if (fScore.innerText >= 800) {
        let emoji = "&#128525";
        message.innerHTML = "OOO !! İNANILMAZ !!" + emoji;
    } else if (fScore.innerText >= 500) {
        let emoji = "&#128531";
        message.innerHTML = "ÇOK YAKIN !!" + emoji;
    } else if (fScore.innerText >= 100) {
        let emoji = "&#128549";
        message.innerHTML = "Bir dahaki sefere daha iyi şanslar " + emoji;
    } else {
        let emoji = "&#128577";
        message.innerHTML = "KÖTÜ DENEME " + emoji;
    }
}
